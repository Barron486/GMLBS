---
title: Leica Biosystems 產品規格知識庫
description: A knowledge base for Leica Biosystems Pathology Products
review_status: pending-review
last_verified: null
regions: [global, TW, US, EU]
regulatory_use: not-applicable
source_urls: []
---

# Leica Biosystems 產品規格知識庫

> [!WARNING] 尚待正式來源逐項驗證
> 本頁資料僅供參考；在完成產品、地區與法規核對前，不可直接用於報價、招標文件或臨床決策。

歡迎來到 **Leica Biosystems 產品規格知識庫**。
...
- **[[HI/Leica_Biosystems_Histology_Consumables|Leica Biosystems 組織學消耗品完整說明]]**：官方旗艦耗材總覽（刀片、包埋盒、抗體、載玻片）。
...
- **2026.03.12**:
  - **Consumables**: 新增 [[HI/Leica_Biosystems_Histology_Consumables|Leica Biosystems 組織學消耗品完整說明]]，涵蓋 10 大類病理核心耗材。
