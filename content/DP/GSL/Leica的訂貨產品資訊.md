# CytoInsight GSL 訂貨產品資訊

> 以下為 CytoInsight GSL 系列的訂貨參考資訊。實際料號請以最新版 Leica Biosystems 報價系統為準。
...
| 型號 | 說明 | 備註 |
| :--- | :--- | :--- |
| **CytoInsight GSL10** | 10 片裝臨床 FISH 掃描系統 | 含基本配置物鏡、螢光模組 |
| **CytoInsight GSL120** | 120 片裝高通量臨床 FISH 掃描系統 | 含全自動進樣器、基本配置物鏡、螢光模組 |
